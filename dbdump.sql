...
CREATE TABLE `artists` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_artist_label_idx` (`label_id`),
  CONSTRAINT `fk_artist_label` FOREIGN KEY (`label_id`) REFERENCES `labels` (`id`)
...
INSERT INTO `labels` VALUES (1,'Mute Records','United Kingdom'),(2,'Parkwood Entertainment','United States');
